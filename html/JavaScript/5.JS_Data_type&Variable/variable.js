...
/*
    호이스팅 : var 키워드나 function 키워드로 선언한 변수 혹은 함수에 대해서 스코프 최상위로 옮겨지는 것
    - 변수 생성 3 단계
...
// 원래는 에러가 바로 터져서 39번행이 실행이 안되어야 하지만 , undefined가 발생함
// console.log(x);
var x = 10;
if (true) {
    var x = 99;
...
/*
    ...
    - 블록 레벨 스코프 : 코드 블럭 내에서 선언된 변수는 코드 블럭 안에서 사용 가능, 코드 블럭 밖에서는 사용 불가능
*/
