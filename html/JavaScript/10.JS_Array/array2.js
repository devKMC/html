...
/*
    ...
    - 원본 배열 변경 X
    - breack, continue, ... 부가적인 작업을 추가 X
    - for 문보다 성능이 떨어짐 , 가독성이 좋고 편리하므로 자주 사용됨 
    - index는 제거할 수 있으나 item은 꼭 있어야함
...
/*
    ...
    - 원본 배열 변경 X 
    - forEach 단순히 요소를 가지고 작업만 진행 ( 반환 값 X ) , map 요소를 가지고 작업한 결과는 배열을 새로 만듬 ( 반환 값 O )
*/
...
/*
    find(콜백 함수) : 콜백함수의 결과가 true 인 첫번째 요소를 반환
*/
...
/*
    findindex(콜백 함수) : 콜백 함수 결과가 true 인 첫번째 요소의 인덱스를 반환
*/
